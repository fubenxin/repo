    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/log/list">日志管理</a></li>
            ...
            <div class="box box-primary">
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_asc sorting_asc_disabled">操作者用户名</th>
                                <th class="sorting_desc sorting_desc_disabled">访问ip</th>
                                <th class="sorting">访问资源url</th>
                                <th class="text-center sorting">执行时长</th>
                                <th class="text-center sorting">执行方法</th>
                            ...
                            <c:forEach items="${pageInfo.list}" var="sysLog">
                                <tr>
                                    ...
                                    <td>${sysLog.ip}</td>
                                    <td>${sysLog.url}</td>
                                    <td class="text-center">${sysLog.executionTime}</td>
                                    <td class="text-center">${sysLog.method}</td>
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/log/detail?id=${sysLog.id}"
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/log/list?page=1&size=${pageInfo.pageSize}"
                                   aria-label="Previous">首页</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/log/list?page=${pageInfo.pageNum - 1}&size=${pageInfo.pageSize}">上一页</a>
                            </li>
                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                <li>
                                    <a href="${pageContext.request.contextPath}/log/list?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a>
                                </li>
                            </c:forEach>
                            <li>
                                <a href="${pageContext.request.contextPath}/log/list?page=${pageInfo.pageNum + 1}&size=${pageInfo.pageSize}">下一页</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/log/list?page=${pageInfo.pages}&size=${pageInfo.pageSize}"
...
<script>
    ...
    function changePageSize() {
        ...
        location.href = "${pageContext.request.contextPath}/log/list?page=1&size=" + pageSize;
    }
